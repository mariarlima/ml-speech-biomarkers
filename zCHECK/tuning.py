...
#         ('clf', model)  # base_model with random_state=42
#     ])
#     cv_obj = StratifiedKFold(n_splits=10, shuffle=True, random_state=SEED)

#     search = RandomizedSearchCV(
#         estimator=pipe,
#         param_distributions=params,   # keys must be 'clf__...' (prefix applied in create_param_grids)
#         n_iter=50,
#         cv=cv_obj,
#         verbose=1,
#         random_state=SEED,
#         n_jobs=-1,
#         refit="roc_auc", # "roc_auc",  # or "accuracy"
#         error_score="raise",
#     )
#     search.fit(X, y)
